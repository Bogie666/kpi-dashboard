...
const SeerSavingsCalculator = ({ hideHeader }) => {
    ...
    <div>
      {!hideHeader && (
        <div className="flex items-center space-x-2 mb-4">
          <h3 className="text-lg font-medium">SEER Savings Calculator</h3>
        </div>
      )}

      <p className="text-sm text-gray-400 mb-4">
        Embed this calculator on your website to help customers estimate energy savings when upgrading their HVAC system. Copy the code below and paste it into any HTML page.
      </p>
      ...
      <div className="relative mb-6">
        ...
        <pre className="bg-gray-950 text-gray-300 text-xs p-4 rounded-b-lg border border-gray-700 overflow-x-auto max-h-48 overflow-y-auto">
...
export default SeerSavingsCalculator;
